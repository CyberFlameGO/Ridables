...
public class EntityRidableSkeleton extends EntitySkeleton implements RidableEntity {
    ...
    public EntityRidableSkeleton(World world) {
        super(world);
    ...
    public float getSpeed() {
        return (float) getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue() * Config.SKELETON_SPEED * 0.8F;
    }

...
public class RidableZombieVillager extends EntityZombieVillager implements RidableEntity {
    private static ZombieVillagerConfig config;

    private final ControllerWASD controllerWASD;

    public RidableZombieVillager(EntityTypes<? extends EntityZombieVillager> entitytypes, World world) {
    ...
    @Override
    public ZombieVillagerConfig getConfig() {
        return (ZombieVillagerConfig) getType().getConfig();
    }

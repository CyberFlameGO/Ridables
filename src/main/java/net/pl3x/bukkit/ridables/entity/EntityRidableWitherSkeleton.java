...
public class EntityRidableWitherSkeleton extends EntitySkeletonWither implements RidableEntity {
    ...
    public EntityRidableWitherSkeleton(World world) {
        super(world);
    ...
    public float getSpeed() {
        return (float) getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue() * Config.WITHER_SKELETON_SPEED * 0.8F;
    }

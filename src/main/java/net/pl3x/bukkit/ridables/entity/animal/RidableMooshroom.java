...
public class RidableMooshroom extends EntityMushroomCow implements RidableEntity {
    private static MooshroomConfig config;

    private final ControllerWASD controllerWASD;

    public RidableMooshroom(EntityTypes<? extends EntityMushroomCow> entitytypes, World world) {
    ...
    @Override
    public MooshroomConfig getConfig() {
        return (MooshroomConfig) getType().getConfig();
    }

...
public class EntityRidableSilverfish extends EntitySilverfish implements RidableEntity {
    ...
    public EntityRidableSilverfish(World world) {
        super(world);
    ...
    public float getSpeed() {
        return (float) getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue() * Config.SILVERFISH_SPEED * 0.8F;
    }

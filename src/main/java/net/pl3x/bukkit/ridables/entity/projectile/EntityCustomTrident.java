...
public class EntityCustomTrident extends EntityThrownTrident {
    ...
    private final EntityRidableDrowned drowned;
    private final EntityPlayer rider;

    public EntityCustomTrident(World world) {
        super(world);
        this.drowned = null;
        this.rider = null;
    ...
    public EntityCustomTrident(World world, EntityRidableDrowned drowned, EntityPlayer rider, ItemStack itemStack) {

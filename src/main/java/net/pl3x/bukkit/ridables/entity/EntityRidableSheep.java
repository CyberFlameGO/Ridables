...
public class EntityRidableSheep extends EntitySheep implements RidableEntity {
    private static Field jumping;
    private boolean isJumping = false;

    public EntityRidableSheep(World world) {
        super(world);
    ...
    public void a(float f, float f1, float f2) {
        ...
        if (rider != null) {
            ...
            if (isJumping && onGround) {
                motY = (double) Config.SHEEP_JUMP_POWER;
                ...
                impulse = true;
                if (forward > 0.0F) {
                    motX += (double) (-0.4F * MathHelper.sin(yaw * 0.017453292F) * Config.SHEEP_JUMP_POWER);
                    motZ += (double) (0.4F * MathHelper.cos(yaw * 0.017453292F) * Config.SHEEP_JUMP_POWER);
                }
            }

            // move
            Mover.moveOnLand(this, strafe, f1, forward, Config.SHEEP_SPEED);
    ...
    private EntityPlayer getRider() {
        ...
        return null; // aww, lonely sheep is lonely
    }
}

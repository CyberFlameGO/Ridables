package net.pl3x.bukkit.ridables.entity.ai.goal.elder_guardian;
...
public class AIElderGuardianAttack extends PathfinderGoal {
    private final RidableElderGuardian guardian;
    private int timer;

    public AIElderGuardianAttack(RidableElderGuardian guardian) {

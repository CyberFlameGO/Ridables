...
public class RidableCow extends EntityCow implements RidableEntity {
    private static CowConfig config;

    private final ControllerWASD controllerWASD;

    public RidableCow(EntityTypes<? extends EntityCow> entitytypes, World world) {
    ...
    public CowConfig getConfig() {
        return (CowConfig) getType().getConfig();
    }
    ...
    protected void initPathfinder() {
        ...
        goalSelector.a(3, new PathfinderGoalTempt(this, 1.25D, RecipeItemStack.a(Items.WHEAT), false) {
            public boolean a() { // shouldExecute
                return getRider() == null && super.a();
            }

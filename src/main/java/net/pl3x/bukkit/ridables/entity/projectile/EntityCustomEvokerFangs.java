...
public class EntityCustomEvokerFangs extends EntityEvokerFangs {
    ...
    public EntityCustomEvokerFangs(World world, double x, double y, double z, float rotationYaw, int warmupDelayTicks, EntityRidableEvoker evoker, EntityPlayer rider) {

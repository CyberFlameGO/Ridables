...
public class RidableMushroomCow extends EntityMushroomCow implements RidableEntity {
    ...
    public RidableMushroomCow(World world) {
        super(world);
    ...
    public float getSpeed() {
        return (float) getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue() * Config.MOOSHROOM_SPEED;
    }

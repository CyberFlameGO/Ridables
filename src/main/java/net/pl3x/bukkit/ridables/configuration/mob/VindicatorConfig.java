...
public class VindicatorConfig extends MobConfig {
    public double BASE_SPEED = 0.35D;
    public double MAX_HEALTH = 24.0D;
    public float AI_JUMP_POWER = 0.42F;
    public float AI_STEP_HEIGHT = 0.6F;
    public double AI_MELEE_DAMAGE = 5.0D;
    public double AI_FOLLOW_RANGE = 12.0D;
    public double RIDING_SPEED = 0.35D;
    ...
    public VindicatorConfig() {
        super("vindicator.yml");
        reload();
    }

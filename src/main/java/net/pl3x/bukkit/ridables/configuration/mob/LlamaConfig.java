...
public class LlamaConfig extends MobConfig {
    ...
    public boolean RIDING_STARTS_CARAVAN = true;
    ...
    public void reload() {
        ...
        if (firstLoad) {
            ...
            addDefault("riding.starts-caravan", RIDING_STARTS_CARAVAN);
            save();
        }
        ...
        RIDING_STARTS_CARAVAN = getBoolean("riding.starts-caravan");

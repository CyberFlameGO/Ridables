...
public class PolarBearConfig extends MobConfig {
    ...
    public boolean RIDING_STAND_ON_SPACEBAR = true;
    ...
    public void reload() {
        ...
        if (firstLoad) {
            ...
            addDefault("riding.stand-on-spacebar", RIDING_STAND_ON_SPACEBAR);
            save();
        }
        ...
        RIDING_STAND_ON_SPACEBAR = getBoolean("riding.stand-on-spacebar");

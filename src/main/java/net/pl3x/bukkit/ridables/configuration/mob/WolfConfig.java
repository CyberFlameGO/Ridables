...
public class WolfConfig extends MobConfig {
    public double BASE_SPEED = 0.3D;
    public double MAX_HEALTH_TAMED = 20.0D;
    public double MAX_HEALTH_UNTAMED = 8.0D;
    public float AI_JUMP_POWER = 0.42F;
    public float AI_STEP_HEIGHT = 0.6F;
    public double AI_FOLLOW_RANGE = 16.0D;
    public double AI_MELEE_DAMAGE_TAMED = 4.0D;
    public double AI_MELEE_DAMAGE_UNTAMED = 4.0D;
    ...
    public void reload() {
        ...
        if (firstLoad) {
            ...
            addDefault("max-health.tamed", MAX_HEALTH_TAMED);
            addDefault("max-health.not-tamed", MAX_HEALTH_UNTAMED);
            addDefault("ai.jump-power", AI_JUMP_POWER);
            addDefault("ai.step-height", AI_STEP_HEIGHT);
            addDefault("ai.follow-range", AI_FOLLOW_RANGE);
            addDefault("ai.melee-damage.tamed", AI_MELEE_DAMAGE_TAMED);
            addDefault("ai.melee-damage.not-tamed", AI_MELEE_DAMAGE_UNTAMED);
        ...
        MAX_HEALTH_TAMED = getDouble("max-health.tamed");
        MAX_HEALTH_UNTAMED = getDouble("max-health.not-tamed");
        ...
        AI_MELEE_DAMAGE_TAMED = getDouble("ai.melee-damage.tamed");
        AI_MELEE_DAMAGE_UNTAMED = getDouble("ai.melee-damage.not-tamed");

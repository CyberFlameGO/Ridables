...
public class PigConfig extends MobConfig {
    ...
    public void reload() {
        ...
        if (firstLoad) {
            ...
            addDefault("get-saddle-back", GET_SADDLE_BACK);
            save();
        }
        ...
        GET_SADDLE_BACK = getBoolean("get-saddle-back");
    }
}

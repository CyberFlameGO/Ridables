...
public class WitherSkeletonConfig extends MobConfig {
    ...
    public void reload() {
        ...
        if (firstLoad) {
            ...
            addDefault("ai.burn-in-daylight", AI_BURN_IN_DAYLIGHT);
            ...
            addDefault("riding.burn-in-daylight", RIDING_BURN_IN_DAYLIGHT);
            save();
        }
        ...
        AI_BURN_IN_DAYLIGHT = getBoolean("ai.burn-in-daylight");
        ...
        RIDING_BURN_IN_DAYLIGHT = getBoolean("riding.burn-in-daylight");

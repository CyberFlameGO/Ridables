package net.pl3x.bukkit.ridables.bstats;
...
public class Metrics {
    ...
    public Map<String, Object> getPluginData() {
        ...
        List<Object> customCharts = new ArrayList<>();
        for (CustomChart customChart : charts) {
            // Add the data of the custom charts
            Map<String, Object> chart = customChart.getRequestJsonObject();
    ...
    public static class SimpleBarChart extends CustomChart {
        ...
        protected Map<String, Object> getChartData() throws Exception {
            ...
            for (Map.Entry<String, Integer> entry : map.entrySet()) {
                List<Object> categoryValues = new ArrayList<>();
